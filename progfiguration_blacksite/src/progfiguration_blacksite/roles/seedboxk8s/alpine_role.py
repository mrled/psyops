...
TODO: THIS IS FOR PSYOPSOS, AND IT'S NOT YET WORKING.
...
class Role(ProgfigurationRole):
    ...
    def apply(self):
        ...
        magicrun("rc-update add rpcbind default")
        magicrun("rc-service rpcbind start")
        self.localhost.cp(self.role_file("exports.txt"), "/etc/exports", "root", "root", 0o644)
        magicrun("exportfs -rav")
        magicrun("rc-update add nfs default")
        magicrun("rc-service nfs start")
        ...
        magicrun("update-ca-certificates")
        ...
        # k0s service
        if not os.path.exists("/etc/systemd/systemtmp/kubeseal/k0scontroller.service"):
